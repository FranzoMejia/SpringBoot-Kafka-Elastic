...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(TwitterKafkaStatusListener twitterKafkaStatusListener,
                                 TwitterToKakfaConfigData twitterToKakfaConfigData) {
        this.twitterKafkaStatusListener = twitterKafkaStatusListener;
        this.twitterToKakfaConfigData = twitterToKakfaConfigData;
    }
    @Override
    public void start() throws TwitterException {
        String[] keywords = twitterToKakfaConfigData.getTwitterKeywords().toArray(new String[0]);
        int minTweetLength = twitterToKakfaConfigData.getMockMinTweetLength();
        int maxTweetLength = twitterToKakfaConfigData.getMockMaxTweetLength();
        long sleepTimeMs = twitterToKakfaConfigData.getMockSleepMs();
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping waiting for a new status");
        }
    }
