...
public class TwitterAnalyticsAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public int hashCode() {
    ...
    result = 31 * result + (wordCount == null ? 0 : wordCount.hashCode());
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TwitterAnalyticsAvroModel)) {
      return false;
    }
    TwitterAnalyticsAvroModel other = (TwitterAnalyticsAvroModel) o;
    if (!java.util.Objects.equals(this.word, other.word)) {
      return false;
    }
    if (!java.util.Objects.equals(this.wordCount, other.wordCount)) {
      return false;
    }
