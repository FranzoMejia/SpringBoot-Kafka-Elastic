...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    @EventListener
    public void inAppStarted(ApplicationStartedEvent event){
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        LOG.info("{} number of messages received with keys {}, partitions {} and offsets {}, " +"sending to elasticsearch: Thread id {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString(),
